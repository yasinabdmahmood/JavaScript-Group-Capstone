...
/***/ "./src/modules/implementScrollUp.js":
/*!******************************************!*\
  !*** ./src/modules/implementScrollUp.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ implementScrollUp)\n/* harmony export */ });\nfunction implementScrollUp() {\n  let isScroll = false;\n  document.body.onscroll = () => {\n    const scrollTop = window.pageYOffset\n      || (document.documentElemen\n          || document.body.parentNode\n          || document.body).scrollTop;\n    if (scrollTop > 0) {\n      isScroll = true;\n      document.getElementById('scroll-up').style.display = 'unset';\n    } else {\n      isScroll = false;\n      document.getElementById('scroll-up').style.display = 'none';\n    }\n    if (window.screen.width < 768) {\n      document.getElementById('scroll-up').style.display = 'none';\n    }\n  };\n  document.getElementById('scroll-up').onclick = () => {\n    if (isScroll) {\n      window.scrollBy({\n        top: -3000,\n        behavior: 'smooth',\n      });\n    }\n  };\n}\n\n//# sourceURL=webpack://javascript-group-capstone/./src/modules/implementScrollUp.js?");
